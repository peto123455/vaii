...
<template>
  <main class="home">
    ...
    <News v-for="(item, index) in state.state.topics" :flipped="(index % 2 == 0 ? true : false)" :topic="item as Topic"/>
    ...
    <News title="Nové vozidlá" imgSrc="/static-img/news-2.jpg" :flipped="true">
