    ...
    <div class="mt-5">
      <div class="container-fluid">
        ...
        <p class="col-md-12 fs-4">
          Naša autoškola sa vyznačuje profesionálnym prístupom a vysokou úrovňou výučby. 
          Naši skúsení inštruktori sú tu, aby vás viedli každým krokom na vašej ceste k vodičskej zručnosti. 
          Sú trpezliví, ochotní a vždy pripravení odpovedať na vaše otázky a pomôcť vám zvládnuť všetky náročné situácie na ceste.
        </p>
      </div>
    </div>
